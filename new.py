...
def draw_path(start_coord, path, color):
    for point in range(len(path)):
        if point == 0:
            pygame.draw.line(surf, color, start_coord[0], path[point + 1], 3)
        if point + 1 == len(path):
            break
        if point >= 1:
            pygame.draw.line(surf, color, path[point], path[point + 1], 3)
...
# goal_coordianets = [(60,240)]
# center_list = read_coordinates('old_txt/txt_files5/boundaries_detector.txt')
# obstacles_coordinates = [(200,130),(200,280)]
# start_coordinates = [(400,280)]

# goal_coordianets = [(250,70)]
# center_list = [(0, 0), (0, 500), (500, 500), (500, 0)]
# obstacles_coordinates = [(300,300),(250,250),(200,200), (400,400),(100,100)]
# start_coordinates = [(250,400)]

# goal_coordianets = [(100,100)]
# center_list = [(0, 0), (0, 500), (500, 500), (500, 0)]
# obstacles_coordinates = [(200,100),(200,200),(300,200), (350,350)]
# start_coordinates = [(400,400)]

#krytyczny przypadek
# goal_coordianets = [(50,420)]
# center_list = [(0, 0), (0, 500), (500, 500), (500, 0)]
# obstacles_coordinates = [(100,100),(100,150),(100,200), (150,200), (200,200), (250,200)]
# start_coordinates = [(200,120)]

goal_coordianets = [(50,420)]
center_list = [(0, 0), (0, 500), (500, 500), (500, 0)]
obstacles_coordinates = [(150,250), (100,300),(150,200), (200,200), (250,200), (250,150), (250,100)]
start_coordinates = [(200,120)]

# goal_coordianets = [(400,450)]
# center_list = [(0, 0), (0, 500), (500, 500), (500, 0)]
# obstacles_coordinates = [(250,100),(250,250),(250,200), (250,150), (30,300),(80,300), (130,300), (180,300)]
# start_coordinates = [(50,30)]
            ...
            if len(q) == 1:
                ...
                if (
                    ...
                    if (check_obstacle(obstacles_coordinates_new, p0_x, p0_y)) == 0:
                        pygame.draw.rect(surf, color, pygame.Rect(p0_x, p0_y, rect_len, rect_len), 1)
                        # pygame.draw.circle(surf, color, (p0_x, p0_y), rect_len, 1)
                ...
                if (
                    ...
                    if (check_obstacle(obstacles_coordinates_new, p1_x, p1_y)) == 0:
                        pygame.draw.rect(surf, color, pygame.Rect(p1_x, p1_y, rect_len, rect_len), 1)
                        # pygame.draw.circle(surf, color, (p1_x, p1_y), rect_len, 1)
                ...
                if (
                    ...
                    if (check_obstacle(obstacles_coordinates_new, p2_x, p2_y)) == 0:
                        pygame.draw.rect(surf, color, pygame.Rect(p2_x, p2_y, rect_len, rect_len), 1)
                        # pygame.draw.circle(surf, color, (p2_x, p2_y), rect_len, 1)
                ...
                if (
                    ...
                    if (check_obstacle(obstacles_coordinates_new, p3_x, p3_y)) == 0:
                        pygame.draw.rect(surf, color, pygame.Rect(p3_x, p3_y, rect_len, rect_len), 1)
                        # pygame.draw.circle(surf, color, (p3_x, p3_y), rect_len, 1)
                ...
                if (
                    ...
                    if (check_obstacle(obstacles_coordinates_new, p4_x, p4_y)) == 0:
                        pygame.draw.rect(surf, color, pygame.Rect(p4_x, p4_y, rect_len, rect_len), 1)
                        # pygame.draw.circle(surf, color, (p4_x, p4_y), rect_len, 1)
                ...
                if (
                    ...
                    if (check_obstacle(obstacles_coordinates_new, p5_x, p5_y)) == 0:
                        pygame.draw.rect(surf, color, pygame.Rect(p5_x, p5_y, rect_len, rect_len), 1)
                        # pygame.draw.circle(surf, color, (p5_x, p5_y), rect_len, 1)
                ...
                if (
                    ...
                    if (check_obstacle(obstacles_coordinates_new, p6_x, p6_y)) == 0:
                        pygame.draw.rect(surf, color, pygame.Rect(p6_x, p6_y, rect_len, rect_len), 1)
                        # pygame.draw.circle(surf, color, (p6_x, p6_y),rect_len, 1)
                ...
                if (
                    ...
                    if (check_obstacle(obstacles_coordinates_new, p8_x, p8_y)) == 0:
                        pygame.draw.rect(surf, color, pygame.Rect(p8_x, p8_y, rect_len, rect_len), 1)
                        # pygame.draw.circle(surf, color, (p8_x, p8_y), rect_len, 1)
...
red = (255,0,0)
color1=(100,255,0)
# draw_path(start_coordinates1, generated_path,red)
# draw_path(start_coordinates1, optimal,blue)
# draw_path(start_coordinates1, path_smooth,green)
...
while not crashed:
    ...
    #         pygame.draw.rect(screen, color, pygame.Rect(f[item][0], f[item][1], 20, 20), 1)
    #         pygame.display.update()
    #         time.sleep(0.01)
    # #
    # for point in range(len(generated_path) - 1):
    #     if point == 0:
    #         pygame.draw.line(screen, orange, start_coordinates1[0], generated_path[point + 1], 2)
    #         pygame.display.update()
    #         time.sleep(1)
    #         if point + 1 == len(generated_path):
    #             break
    #         if point >= 1:
    #             pygame.draw.line(screen, orange, generated_path[point], generated_path[point + 1], 2)
    #             pygame.display.update()
    #             time.sleep(0.3)
